                    ...
                    <ul className="tab-product" role="tablist">
                        <li className="nav-tab-item" role="presentation">
                            <a href="#tab1" data-bs-toggle="tab" role="tab"
                                className="active fw-6 letter-space--3">Monthly</a>
                        </li>
                        <li className="nav-tab-item" role="presentation">
                            <a href="#tab2" data-bs-toggle="tab" role="tab"
                                className="fw-6 letter-space--3 d-flex align-items-center g-7">Yearly <span
                                    className="badge-sale">20% off</span></a>
                        </li>
                    </ul>
                </div>
                                    ...
                                    <div className="pricing-card style-2">
                                        <div className="top-card d-flex align-items-center">
                                            ...
                                            <div className="content-top">
                                                <a href="#" className="name-card h5 fw-6 letter-space--3 mb-10">
                                                    Standard Plan
                                                </a>
                                                <p className="text ff-2">
                                                    Standard Plan is designed for growing
                                        ...
                                        <div className="middel-card">
                                            ...
                                            <a href="#" className="tf-btn style-big style-border style-full-w">
                                        ...
                                        <div className="bottom-card">
                                            <ul className="list-benefit-2">
                                                <li className="benefit-2-item text-body-2 ff-2 fw-5 lh-100">Social Media
                                                    Management</li>
                                                <li className="benefit-2-item text-body-2 ff-2 fw-5 lh-100">Basic SEO Setup
                                                </li>
                                                <li className="benefit-2-item text-body-2 ff-2 fw-5 lh-100">Monthly
                                                    Performance Report</li>
                                                <li className="benefit-2-item text-body-2 ff-2 fw-5 lh-100">Email Support
                                                </li>
                                                <li className="benefit-2-item text-body-2 ff-2 fw-5 lh-100">Product
                                                    marketing</li>
                                                <li className="benefit-2-item text-body-2 ff-2 fw-5 lh-100">eCommerce SEO
                                                    camping</li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div className="pricing-card style-2 active">
                                        <div className="top-card d-flex align-items-center">
                                            ...
                                            <div className="content-top">
                                                ...
                                                <p className="text ff-2">
                                                    Growth Package is crafted for businesses
                                                    ready to scale and maximize impact.
                                                </p>
                                            </div>
                                        </div>
                                        <div className="middel-card">
                                            ...
                                            <a href="#" className="tf-btn style-big style-full-w style-color-dt-light">
                                                <span className="text-btn">Get Started</span>
                                                <span className="icon-btn">
                                                    <i className="icon-arrow-up-right"></i>
                                                </span>
                                    ...
                                    <div className="pricing-card style-2">
                                        <div className="top-card d-flex align-items-center">
                                            ...
                                            <div className="content-top">
                                                ...
                                                <p className="text ff-2">
                                                    Premium Package is designed for businesses
                                                    seeking maximum impact and full-scale.
                                                </p>
                                            </div>
                                        </div>
                                        <div className="middel-card">
                                            <div className="price mb-40">
                                                ...
                                                <span className="fw-6 time ff-2 style-bg-dt-light">Month</span>
                                            </div>
                                            <a href="#" className="tf-btn style-big style-border style-full-w">
                                                <span className="text-btn">Get Started</span>
                                                <span className="icon-btn">
                                    ...
                                    <div className="pricing-card style-2">
                                        ...
                                        <div className="middel-card">
                                            <div className="price mb-40">
                                                ...
                                                <span className="fw-6 time ff-2 style-bg-dt-light">Year</span>
                                            </div>
                                            <a href="#" className="tf-btn style-big style-border style-full-w">
                                                <span className="text-btn">Get Started</span>
                                                <span className="icon-btn">
