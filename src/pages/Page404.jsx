  ...
  return (
    <>
      <main id="wrapper">
        ...
        <header className="header style-bg-white style-border-bottom header-fixed">
                ...
                <div className="header-content">
                                ...
                                <li className="menu-item has-sub_menu">
                                    ...
                                    <div className="sub-menu">
                                        <ul className="sub-menu_list">
                                            ...
                                            <li>
                                                <a href="/404" className="sub-menu_link active">404</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                    ...
                    <div className="header-right d-flex align-items-center g-20">
                        ...
                        <div className="d-none d-xl-block">
                            <a href="#pop-up-sidebar" data-bs-toggle="modal" className="tf-btn-sidebar style-dt-black">
                        ...
                        <div className="d-xl-none">
                            <a href="#mobileMenu" data-bs-toggle="offcanvas"
                                className=" mobile-button style-color-dt-black">
                                <span></span>
                                <span></span>
                                <span></span>
                            </a>
        ...
        <div className="container">
            <div className="wg-404 flat-spacing-1">

                <div className="img-bg">
                    <img src="./assets/images/widget/img-bg-404.png" alt="Image" />
                </div>

                <div className="left content-wg">
                    <div className="heading-section">
                        <div className="top">
                            <div className="sub-title h6 mb-10 letter-space--2 fw-5">
                                404. <span>Well, this is awkward…</span>
                            </div>
                            <h2 className="title letter-space--3 fw-6 mb-xl-100">
                                Sorry, the page
                                you’re looking for
                                isn’t here.
                            </h2>
                        ...
                        <div className="bottom">
                            <p className="desc text-body-2 ff-2 letter-space--2 fw-5 color-paragraph mb-xl-50">
                                Don’t worry—use the navigation menu or return to the
                                homepage to continue exploring. We’re here to help you get
                                back on track quickly and easily.
                            </p>
                            <a href="/" className="tf-btn style-big style-color-dt-blue">
                                <span className="text-btn">Goto home</span>
                                <span className="icon-btn">
                                    <i className="icon-arrow-up-right"></i>
                                </span>
                            </a>
                ...
                <div className="right">
                    <div className="image">
                        <img loading='lazy' alt='Image' width='574' height='600'
