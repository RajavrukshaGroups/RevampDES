...
import WebAppImage1 from '../../../assets/images/portfolio/portfolioDetailsImages/web-dev/WebAppImage1.jpg';
import WebAppImage2 from '../../../assets/images/portfolio/portfolioDetailsImages/web-dev/WebAppImage2.jpg';
import WebAppImage3 from '../../../assets/images/portfolio/portfolioDetailsImages/web-dev/WebAppImage3.jpg';
                    ...
                    <div className="row align-items-center mb-60">
                        <div className="col-lg-8">
                            <p className="h3 letter-space--3 fw-6 color-dt-black mb-0">
                                Our Recent <span className="color-dt-blue">Web Applications</span>
                            </p>
                        </div>
        ...
        <section className="section-profilio-detail flat-spacing-1">
                ...
                <div className="row">
                    <div className="col-lg-10">
                        <p className="h3 letter-space--3 fw-6 mb-70">
                            Transform your business operations with our custom web application development services. 
                            We design and build scalable, high-performance web applications that automate processes, 
                            enhance productivity, and solve complex business challenges.
                        </p>
                    </div>
                    ...
                    <div className="project-information-item mb-74">
                        <div className="image">
                            <img loading="lazy" width="960" height="570"
                                src={WebAppImage1} alt="Web Application Development" />
                        </div>
                        <div className="content">
                            ...
                            <ul>
                                <li>
                                    Service Type:
                                    <p className="h6 fw-6 letter-space--3 color-black">Web Application Development</p>
                                </li>
                                <li>
                                    Technologies:
                                    <p className="h6 fw-6 letter-space--3 color-black">React, Angular, Node.js, Python</p>
                                </li>
                                <li>
                                    Features:
                                    <p className="h6 fw-6 letter-space--3 color-black">Real-Time, API Integration</p>
                                </li>
                                <li>
                                    Architecture:
                                    <p className="h6 fw-6 letter-space--3 color-black">Microservices, Cloud-Native</p>
                                </li>
                                <li>
                                    Security:
                                    <p className="h6 fw-6 letter-space--3 color-black">OAuth, JWT, Data Encryption</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="project-challenges-item flat-spacing-2">
                        ...
                        <p className="desc ff-2 color-paragraph mb-30">
                            Our web applications are built to meet the specific needs of your business, 
                            combining powerful functionality with intuitive user interfaces that drive 
                            efficiency and engagement.
                        </p>

                        <ul>
                            <li className="text-body-2 color-paragraph mb-10">
                                <span className="fw-6 color-dt-black letter-space--3">Real-Time Processing –</span> 
                                Instant data updates and real-time collaboration capabilities.
                            </li>
                            <li className="text-body-2 color-paragraph mb-10">
                                <span className="fw-6 color-dt-black letter-space--3">API Integration –</span>
                                Seamless connectivity with third-party services and systems.
                            </li>
                            <li className="text-body-2 color-paragraph mb-10">
                                <span className="fw-6 color-dt-black letter-space--3">Scalable Architecture –</span>
                                Built to handle growth and increased user demands.
                            </li>
                            <li className="text-body-2 color-paragraph mb-10">
                                <span className="fw-6 color-dt-black letter-space--3">Mobile Responsive –</span> 
                                Optimized for all screen sizes and devices.
                            </li>
                            <li className="text-body-2 color-paragraph">
                                <span className="fw-6 color-dt-black letter-space--3">Advanced Security –</span>
                        ...
                        <div className="col-sm-6 col-lg-5">
                            <div className="project-results-content">
                                ...
                                <div className="desc ff-2 color-paragraph">
                                    Our proven development process ensures your web application is built to 
                                    the highest standards, delivered on time, and exceeds your expectations.
                                </div>
                                <ul>
                        ...
                        <div className="col-sm-6 col-lg-7">
                            <div className="image">
                                <img loading="lazy" width="740" height="470"
                                    src={WebAppImage2} alt="Application Development Process" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="container">
                <div className="image-section mb-74">
                    <img loading="lazy" 
                        src={WebAppImage3} alt="Web Application Showcase" />
                </div>
            </div>
                    ...
                    <div className="row justify-content-between rg-30">
                        <div className="col-lg-6">
                            <div className="desc text-body-1 ff-2 fw-5 letter-space--2 lh-35">
                                Web application development enables businesses to streamline operations, 
                                improve efficiency, and deliver enhanced experiences to customers and employees 
                                through custom-built digital solutions.
                            </div>
                        </div>

                        <div className="col-lg-5">
                            <div className="text ff-2 color-paragraph">
                                We specialize in creating custom web applications that solve complex business 
                                problems and drive digital transformation. From initial concept to final deployment, 
                                our team follows a structured development methodology that emphasizes quality, 
                                performance, and user experience. We leverage modern technologies and frameworks 
                                to build applications that are robust, scalable, and maintainable. Our expertise 
                                includes developing everything from simple business applications to complex 
                                enterprise solutions with extensive features and integrations. We provide 
                                comprehensive documentation and training to ensure your team can effectively use 
                                and maintain the application long after launch.
                            </div>
                        </div>
                    </div>
                </div>
