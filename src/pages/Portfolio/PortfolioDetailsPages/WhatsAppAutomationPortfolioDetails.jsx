...
import WebAppImage1 from '../../../assets/images/portfolio/portfolioDetailsImages/whatsapp-automation/WebAppImage1.jpg';
import WebAppImage2 from '../../../assets/images/portfolio/portfolioDetailsImages/whatsapp-automation/WebAppImage2.jpg';
import WebAppImage3 from '../../../assets/images/portfolio/portfolioDetailsImages/whatsapp-automation/WebAppImage3.jpg';
...
export default function WhatsAppAutomation() {
  ...
  const portfolioItems = [
    {
      id: 1,
      title: "E-Commerce WhatsApp Automation",
    ...
    {
      id: 4,
      title: "Education Institute Alerts",
      category: "WhatsApp Automation",
      image: Portfolio4,
      link: "#"
    },
    {
      id: 5,
      title: "Financial Services Notifications",
      category: "WhatsApp Automation",
      image: Portfolio5,
      link: "#"
    }
                    ...
                    <div className="row align-items-center mb-60">
                        <div className="col-lg-8">
                            <p className="h3 letter-space--3 fw-6 color-dt-black mb-0">
                                Our Recent <span className="color-dt-blue">WhatsApp Automation</span> Projects
                            </p>
                        </div>
        ...
        <section className="section-profilio-detail flat-spacing-1">
                ...
                <div className="row">
                    <div className="col-lg-10">
                        <p className="h3 letter-space--3 fw-6 mb-70">
                            Revolutionize your customer communication with our WhatsApp Automation solutions. 
                            We help businesses leverage WhatsApp's massive reach to automate conversations, 
                            nurture leads, provide instant support, and drive conversions through personalized messaging.
                        </p>
                    </div>
                    ...
                    <div className="project-information-item mb-74">
                        <div className="image">
                            <img loading="lazy" width="960" height="570"
                                src={WebAppImage1} alt="WhatsApp Automation Services" />
                        </div>
                        <div className="content">
                            ...
                            <ul>
                                <li>
                                    Service Type:
                                    <p className="h6 fw-6 letter-space--3 color-black">WhatsApp Automation</p>
                                </li>
                                <li>
                                    Platform:
                                    <p className="h6 fw-6 letter-space--3 color-black">WhatsApp Business API</p>
                                </li>
                                <li>
                                    Features:
                                    <p className="h6 fw-6 letter-space--3 color-black">Auto-Reply, Broadcast, CRM Integration</p>
                                </li>
                                <li>
                                    Use Cases:
                                    <p className="h6 fw-6 letter-space--3 color-black">Sales, Support, Marketing, Notifications</p>
                                </li>
                                <li>
                                    Integration:
                                    <p className="h6 fw-6 letter-space--3 color-black">CRM, E-Commerce, Helpdesk</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="project-challenges-item flat-spacing-2">
                        ...
                        <p className="desc ff-2 color-paragraph mb-30">
                            Our WhatsApp Automation solutions enable businesses to scale their communication 
                            efforts, improve response times, and create meaningful customer interactions at scale.
                        </p>

                        <ul>
                            <li className="text-body-2 color-paragraph mb-10">
                                <span className="fw-6 color-dt-black letter-space--3">Automated Chatbots –</span> 
                                AI-powered chatbots that handle customer queries 24/7 without human intervention.
                            </li>
                            <li className="text-body-2 color-paragraph mb-10">
                                <span className="fw-6 color-dt-black letter-space--3">Broadcast Messaging –</span>
                                Send personalized bulk messages to segmented audiences with high deliverability.
                            </li>
                            <li className="text-body-2 color-paragraph mb-10">
                                <span className="fw-6 color-dt-black letter-space--3">CRM Integration –</span>
                                Seamless sync with your CRM for unified customer data and communication history.
                            </li>
                            <li className="text-body-2 color-paragraph mb-10">
                                <span className="fw-6 color-dt-black letter-space--3">Automated Workflows –</span> 
                                Create trigger-based automations for lead nurturing, order updates, and follow-ups.
                            </li>
                            <li className="text-body-2 color-paragraph">
                                <span className="fw-6 color-dt-black letter-space--3">Analytics & Insights –</span>
                                Track message performance, engagement rates, and conversion metrics.
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div className="col-sm-6 col-lg-5">
                            <div className="project-results-content">
                                ...
                                <div className="desc ff-2 color-paragraph">
                                    Our structured implementation process ensures your WhatsApp Automation 
                                    is set up correctly and delivers maximum business value.
                                </div>
                                <ul>
                        ...
                        <div className="col-sm-6 col-lg-7">
                            <div className="image">
                                <img loading="lazy" width="740" height="470"
                                    src={WebAppImage2} alt="WhatsApp Automation Implementation" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="container">
                <div className="image-section mb-74">
                    <img loading="lazy" 
                        src={WebAppImage3} alt="WhatsApp Automation Showcase" />
                </div>
            </div>
                    ...
                    <div className="row justify-content-between rg-30">
                        <div className="col-lg-6">
                            <div className="desc text-body-1 ff-2 fw-5 letter-space--2 lh-35">
                                WhatsApp Automation transforms how businesses communicate with customers, 
                                enabling instant, personalized, and scalable conversations that drive 
                                engagement and conversion across all customer touchpoints.
                            </div>
                        </div>

                        <div className="col-lg-5">
                            <div className="text ff-2 color-paragraph">
                                We specialize in helping businesses leverage the power of WhatsApp through 
                                intelligent automation solutions. Our team works with the official WhatsApp 
                                Business API to ensure compliance, security, and reliability. We design custom 
                                automation workflows that match your business processes and customer journeys. 
                                From lead generation and qualification to post-sale support and re-engagement, 
                                we cover the entire customer lifecycle. Our solutions integrate seamlessly with 
                                your existing tech stack including CRMs, e-commerce platforms, and helpdesk systems. 
                                We provide training and ongoing support to ensure your team maximizes the value 
                                of WhatsApp Automation. With our expertise, you can reduce response times, 
                                improve customer satisfaction, and significantly increase conversion rates 
