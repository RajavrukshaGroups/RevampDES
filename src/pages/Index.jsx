      ...
      <main className="wrapper" id="wrapper">
                                ...
                                <li className="menu-item has-sub_menu">
                                    ...
                                    <div className="sub-menu">
                                        <ul className="sub-menu_list">
                                            <li>
                                                <a href="/" className="sub-menu_link active">Home Digital
                                                    Marketing</a>
                                            </li>
                                            <li>
        ...
        <section className="section-hero">
            ...
            <div className="hero-left">
                <div className="hero-content">
                    <div className="sub-title h6 letter-space--2 fw-5 split-text effect-right">
                        Built for visibility. <span className="color-dt-light">Designed for conversion.</span>
                    </div>
                    <h1 className="title letter-space--3 fw-6 split-text effect-right">
                        Fueling business
                        <br />to growth through
                    ...
                    <div className="desc h5 lh-35 ff-2 fw-5 title-animation">
                        ...
                        <br />driven digital marketing strategies.
                    </div>
                    <a href="/about-us" className="tf-btn style-big style-color-dt-light title-animation">
                ...
                <div className="stats">
                    <div className="counter-item stat">
                        <div className="counter">
                            <div className="number-counter flex fs-65">
                                <span className="number odometer color-primary h1 fw-6" data-to="98" data-inviewport="yes">
                                    0
                                </span>
                    ...
                    <div className="counter-item stat">
                        <div className="counter">
                            <div className="number-counter flex fs-65">
                                <span className="number odometer color-primary h1 fw-6" data-to="4.9" data-inviewport="yes">
                                    0
                                </span>
                            </div>
                        </div>
            ...
            <div className="hero-right">
                <div className="image-hero img-1 mb-10 wow fadeInUp">
                    <img loading="lazy" width="916" height="470" src="./assets/images/section/img-hero-1.jpg"
                        alt="Image" />
                </div>
                <div className="bottom-hero-right d-flex g-10">
                    <div className="d-flex flex-column justify-content-between">
                        <div className="box-team-card mb-10 wow fadeInLeft flex-1">
                            <div className="img-bg">
                                <img src="./assets/images/widget/img-bg-hero-h1.png" alt="Image" />
                            </div>
                                ...
                                <div className="counter-item">
                                    <div className="counter">
                                        <div className="number-counter flex fs-65 fw-6">
                                            <span className="number odometer color-primary h1" data-to="10"
                            ...
                            <div className="list-avatars">
                                <a href="#" className="img-avt">
                                    <img loading="lazy" width="100" height="100"
                                        src="./assets/images/avatar/avt-team-3.jpg" alt="Image" />
                                </a>
                                <a href="#" className="img-avt">
                                    <img loading="lazy" width="100" height="100"
                                        src="./assets/images/avatar/avt-team-2.jpg" alt="Image" />
                                </a>
                                <a href="#" className="img-avt">
                                    <img loading="lazy" width="100" height="100"
                                        src="./assets/images/avatar/avt-team-1.jpg" alt="Image" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="box-quote wow fadeInLeft flex-1">
                            <div className="image">
                                <img src="./assets/images/section/bg-box-quote.jpg" alt="img" />
                            </div>
                            <div className="box-content">
                                ...
                                <div className="user-box">
                                    <a href="#" className="fw-5 letter-space--3">Michael Anderson</a>
                                    <a href="#" className="text-caption letter-space--3 fw-5">CEO & Founder</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="image-hero img-2 wow fadeInRight">
                        <img loading="lazy" width="453" height="470" src="./assets/images/section/img-hero-2.jpg"
                            alt="Image" />
                    </div>
                </div>
            </div>
        ...
        <section className="section-strategy flat-spacing-1 h-dm">
            <div className="container w-1750">
                <div
                    className="top-section heading-section d-flex align-items-end justify-content-between flat-spacing-2 flex-wrap g-30">
                    <div className="letf">
                    ...
                    <div className="right">
                        <p className="desc ff-2 text-body-1 mb-30 lh-32 color-paragraph wow fadeInUp" data-wow-delay=".2s">
                            We focus on creating real, data-driven strategies that deliver
                            <br />measurable results. Every campaign is built on research, insight,
                            <br />and clear objectives—ensuring your marketing.
                        </p>

                        <a href="/about-us" className="tf-btn style-big style-border wow fadeInUp" data-wow-delay=".2s">
                            <span className="text-btn">Learn more</span>
                            <span className="icon-btn">
                                <i className="icon-arrow-up-right"></i>
                            </span>
                ...
                <div className="row rg-30">
                    <div className="col-lg-4">
                        <div className="marketing-card wow fadeInUp">
                            ...
                            <div className="logo">
                                <img src="./assets/images/logo/logo-marketing-card.svg" alt="image" />
                            </div>
                            <div className="content">
                                ...
                                <div className="list-benefit d-flex g-30 rg-15 flex-wrap">
                                    <div className="benefit-item d-flex align-items-center g-10">
                                        ...
                                        <span className="ff-2 fw-5">SEO & Search Visibility</span>
                                    </div>
                                    <div className="benefit-item d-flex align-items-center g-10">
                                        <i className="icon-check fs-24"></i>
                    ...
                    <div className="col-lg-4">
                        <div className="image wow fadeInUp" data-wow-delay=".2s">
                            <img loading="lazy" width="553" height="500"
                                src="./assets/images/section/img-section-strategy.jpg" alt="Image" />
                        </div>
                    </div>
                    <div className="col-lg-4">
                        <div className="growth-card wow fadeInUp" data-wow-delay=".4s">
                            <div className="top-card">
                                <div className="counter-item">
                                    ...
                                    <p className="h5 fw-6 lh-35 ff-2 fw-6 color-paragraph">Business develop growth</p>
                                </div>
                            </div>
            ...
            <div className="container">
                <div className="heading-section mb-70 text-center">
                    ...
                    <h2 className="title letter-space--3 fw-6 mb-30 wow fadeInUp">
                        ...
                        <br />strategists, creatives, and analysts
                        <br />dedicated to growth businesses
                    </h2>

                    <p className="desc ff-2 text-body-1 mb-30 lh-32 fw-5 color-paragraph wow fadeInUp">
                        We are a results-driven digital marketing agency committed to helping brands grow
                        <br />in an ever-evolving digital world focus on measurable results.
                    </p>
                </div>
                ...
                <div className="row rg-30">
                    <div className="col-lg-8">
                        <div className="wg-video wow fadeInUp">
                            <div className="image">
                                <img loading="lazy" width="850" height="470" src="./assets/images/section/img-video.jpg"
                                    alt="Image" />
                            </div>
                    ...
                    <div className="col-lg-4">
                        <div className="testimonial-card wow fadeInUp" data-wow-delay=".2s">
                            <div className="img-sharp">
                                <div className="blob-wrapper">
                                    <div className="blob"></div>
                                </div>
                            ...
                            <p className="h5 text letter-space--3 fw-6 mb-50 lh-32">
                                “A reliable team that truly understands digital growth. Transparent, data-driven,
                                and
                                highly effective.”
                            </p>
                            <div className="d-flex position-relative mb-50">
                                <a href="#" className="img-avt">
                                    <img loading="lazy" width="80" height="80"
                                        src="./assets/images/avatar/avt-testimonial.jpg" alt="Image" />
                                </a>
                                <div className="icon">
                            ...
                            <div className="testimonial-user">
                                <a href="/team-details" className="h5 name fw-6 letter-space--3">Benjamin Harris</a>
            ...
            <div className="container">
                <div className="heading-section flat-spacing-2 text-center style-white">
                    ...
                    <h2 className="title letter-space--3 fw-6 wow fadeInUp">
                        ...
                        <br />connect businesses with the right audience
                        <br />focus is on transparency, performance
                    </h2>
                </div>
            </div>
            <div className="section-working-proccess-inner">
                <div dir="ltr" className="swiper tf-swiper flat-spacing-3" data-laptop="4.45" data-preview="4"
                    data-tablet="3" data-mobile-sm="2" data-mobile="1" data-space-lg="30" data-space-md="15"
                    data-space="15" data-center="true" data-init="2">
                    <div className="swiper-wrapper">
                        ...
                        <div className="swiper-slide d-none d-sm-block">
                            <div className="image-working-proccess img-1">
                                <img loading="lazy" width="410" height="273"
                                    src="./assets/images/widget/img-working-proccess-1.jpg" alt="Image" />
                            </div>
                        </div>
                        ...
                        <div className="swiper-slide d-none d-sm-block">
                            <div className="image-working-proccess img-2">
                                <img loading="lazy" width="410" height="273"
                                    src="./assets/images/widget/img-working-proccess-2.jpg" alt="Image" />
                            </div>
                        </div>
                        ...
                        <div className="swiper-slide">
                            <div className="image-working-proccess img-3">
                                <img loading="lazy" width="410" height="273"
                                    src="./assets/images/widget/img-working-proccess-3.jpg" alt="Image" />
                            </div>
                        </div>
                        ...
                        <div className="swiper-slide d-none d-sm-block">
                            <div className="image-working-proccess img-2">
                                <img loading="lazy" width="410" height="273"
                                    src="./assets/images/widget/img-working-proccess-4.jpg" alt="Image" />
                            </div>
                        </div>
                        ...
                        <div className="swiper-slide d-none d-sm-block">
                            <div className="image-working-proccess img-1">
                                <img loading="lazy" width="410" height="273"
                                    src="./assets/images/widget/img-working-proccess-5.jpg" alt="Image" />
                            </div>
                        </div>
                    ...
                    <div className="bottom-section">
                        <div className="left">
                            <p className="h5 fw-5 letter-space--3 color-white text lh-32 wow fadeInUp">
                                ...
                                <br />strategists, and creatives dedicated to helping
                                <br />brands succeed online.
                            </p>

                            <div className="counter-item wow fadeInUp">
                                <div className="counter">
                                    <div className="number-counter d-flex">
                                        <span className="number odometer color-primary fs-200 lh-100 letter-space--5 fw-6"
                                            data-to="15" data-inviewport="yes"> 0 </span>
                                        <span className="fs-200 lh-100 fw-6 letter-space--5">+</span>
                                    </div>
                                </div>
                        ...
                        <div className="right">
                            <div className="working-item wow fadeInUp" data-wow-delay=".2s">
                                ...
                                <div className="content">
                                    ...
                                    <div className="text ff-2 ">
                                        We begin every project with thorough research and a clear understanding of
                                        your
                                        business objectives.
                                    </div>
                                </div>
                            ...
                            <div className="working-item wow fadeInUp" data-wow-delay=".2s">
                                ...
                                <div className="content">
                                    ...
                                    <div className="text ff-2 ">
                                        Our team transforms insights and strategy into compelling creative concepts
                                        through ideation and design.
                                    </div>
                                </div>
                            ...
                            <div className="working-item wow fadeInUp" data-wow-delay=".2s">
                                ...
                                <div className="content">
                                    ...
                                    <div className="text ff-2 ">
                                        We focus delivering measurable outcomes through rigorous testing and
                                        continuous
                                        optimization.
                                    </div>
                                </div>
        ...
        <section className="section-team h-dm">
            <div className="flat-spacing-3">
                <div className="parallax-main overflow-hidden">
                    <div className="img-section parallax-scaleInUp-large">
                        <img loading="lazy" src="./assets/images/section/img-section-team.jpg" alt="Image" />
                    </div>
                </div>
            </div>
            ...
            <div className="container w-1750">
                <div
                    className="heading-section d-flex align-items-center justify-content-between flat-spacing-2 flex-wrap g-30">
                    <div className="letf">
                        <div className="sub-title h6 mb-10 letter-space--2 fw-5 wow fadeInUp">
                            Meet Our professionals — <span>100+ members.</span>
                        </div>
                        <h2 className="title letter-space--3 fw-6 wow fadeInUp">
                            Together, we collaborate, <br />innovate, & push boundaries.
                        </h2>
                    </div>

                    <div className="right">
                        <p className="desc ff-2 text-body-1 mb-30 lh-32 wow fadeInUp" data-wow-delay=".2s">
                            Team is made up of talented professionals who bring creativity,
                            <br />strategy, and technical expertise to every project.
                        </p>

                        <a href="#" className="tf-btn style-big style-color-dt-blue wow fadeInUp" data-wow-delay=".2s">
            ...
            <div dir="ltr" className="sw-team swiper tf-swiper flat-spacing-3" data-laptop="5" data-preview="4"
                data-tablet="3" data-mobile-sm="2" data-mobile="1" data-space-lg="0" data-space-md="0" data-space="0">
                <div className="swiper-wrapper">
                    ...
                    <div className="swiper-slide">
                        <div className="team-card hover-img">
                            ...
                            <div className="team-content">
                                <a href="/team-details" className="name-team h5 fw-6 letter-space--3">Alexander
                                    Mitchell</a>
            ...
            <div className="container">
                <div className="heading-section mb-70 text-center">
                    ...
                    <h2 className="title letter-space--3 fw-6 wow fadeInUp">
                        ...
                        <br />and a client-focused approach.
                    </h2>
                </div>

                <div className="section-why-inner">
                    <div className="image image-frame">
                        <img id="mainImage" loading="lazy" width="630" height="530"
                            src="./assets/images/section/img-section-why.jpg" alt="Image" />
                    </div>
                    ...
                    <div className="section-content">
                        ...
                        <div className="wg-according" id="According2">
                            <div className="according-item style-2 mb-30"
                                ...
                                <div id="According-1" className="collapse show" data-bs-parent="#According2">
                                    <div className="according-content">
                                        <p className="text ff-2">
                                            We pride ourselves on delivering reliable solutions every maintaining
                                            clear
                                            & transparent communication solutions with our global clients.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="according-item style-2"
            ...
            <div className="container w-1750">
                <div
                    ...
                    <div className="letf">
                        ...
                        <h2 className="title letter-space--3 fw-6 wow fadeInUp">
                            Let’s explore our awards <br />winning projects
                        </h2>
                    </div>

                    <div className="right">
                        <p className="desc ff-2 text-body-1 mb-30 color-paragraph lh-32 wow fadeInUp" data-wow-delay=".2s">
                            We focus on quality, efficiency, and impact, helping
                            <br />businesses achieve growth operations.
                        </p>

                        <a href="#" className="tf-btn style-big style-border wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <div className="tes-item mb-70">
                            <div className="top">
                                ...
                                <div className="text fw-5 text-body-2 letter-space--3 lh-28">
                                    ...
                                    <br />delivered real, measurable growth for
                                    <br />our business. Traffic increased, leads
                                    <br />improved, and conversions followed.
                                    <br />clear communication and consistent
                                    <br />results made trusted partner.”
                                </div>
                            </div>
                            ...
                            <div className="user-tes">
                                ...
                                <a href="#" className="name text-body-1 fw-6 letter-space--3">
                                    Alexander Mitchell
                                </a>
                        ...
                        <div className="tes-item">
                            <div className="top">
                                ...
                                <div className="text fw-5 text-body-2 letter-space--3 lh-28">
                                    ...
                                    <br />everything was well-planned and
                                    <br />performance-driven. We saw steady
                                    <br />improvement across all channels. A
                                    <br />professional team that truly
                                    <br />understands digital growth.”
                                </div>
                            </div>
                            ...
                            <div className="user-tes">
                                <a href="#" className="img-avt">
                                    <img loading="lazy" width="66" height="66"
                                        src="./assets/images/avatar/avt-tes-2.jpg" alt="Image" />
                                </a>
                                <a href="#" className="name text-body-1 fw-6 letter-space--3">
                                    Samantha Carter,
                                </a>
                        ...
                        <div className="tes-item mb-70">
                            <div className="top">
                                ...
                                <div className="text fw-5 text-body-2 letter-space--3 lh-28">
                                    ...
                                    <br />presence with smart strategy and
                                    <br />creative execution. The results were
                                    <br />transparent and easy to track. We
                                    <br />highly recommend them for any
                                    <br />growing business.”
                                </div>
                            </div>
                            ...
                            <div className="user-tes">
                                <a href="#" className="img-avt">
                                    <img loading="lazy" width="66" height="66"
                                        src="./assets/images/avatar/avt-tes-3.jpg" alt="Image" />
                                </a>
                                <a href="#" className="name text-body-1 fw-6 letter-space--3">
                                    Daniel Roberts
                                </a>
                                <p className="position ff-2">
                                    Founder of EcomBoost
                                </p>
                            </div>
                        ...
                        <div className="tes-item">
                            <div className="top">
                                ...
                                <div className="text fw-5 text-body-2 letter-space--3 lh-28">
                                    ...
                                    <br />having an in-house marketing team.
                                    <br />They focused on ROI, not vanity
                                    <br />metrics. The impact on our business
                                    <br />has been outstanding.”
                                </div>
                            </div>
                            ...
                            <div className="user-tes">
                                <a href="#" className="img-avt">
                                    <img loading="lazy" width="66" height="66"
                                        src="./assets/images/avatar/avt-tes-4.jpg" alt="Image" />
                                </a>
                                <a href="#" className="name text-body-1 fw-6 letter-space--3">
                                    Samantha Carter,
                                </a>
            ...
            <div className="flat-spacing-3">
                <div className="parallax-main overflow-hidden">
                    <div className="image-section parallax-scaleInUp-large">
                        <img loading="lazy" src="./assets/images/section/img-section-blog.jpg" alt="Image" />
                    </div>
                </div>
            </div>
            ...
            <div className="container">
                <div className="row justify-content-between rg-50">
                    <div className="col-lg-5">
                        <div className="heading-section">
                            ...
                            <p className="desc ff-2 text-body-1 mb-30 lh-32 color-paragraph wow fadeInUp">
                                We focus on quality, efficiency, and impact, helping businesses achieve growth
                                operations.
                            </p>
                            <a href="#" className="tf-btn style-big style-color-dt-blue wow fadeInUp">
                    ...
                    <div className="col-lg-6">
                        <div className="blog-card style-2 hover-img wow fadeInUp" data-wow-delay=".2s">
                            <a href="/blog-detail" className="image image-blog">
                                <img loading="lazy" width="630" height="430"
                                    src="./assets/images/blog/img-blog-card-8.jpg" alt="Image" />
                            </a>
                            <div className="card-content">
                                <div className="meta d-flex align-items-center flex-wrap g-30 rg-15">
                                    <a href="#" className="user-blog d-flex align-items-center g-15">
                                        <span className="img">
                                            <img loading="lazy" width="40" height="40"
                                                src="./assets/images/avatar/avt-blog.jpg" alt="Image" />
                                        </span>
                                        <span className="color-paragraph">by <span
                                                className="color-dt-black">admin</span></span>
                                    </a>
                                    <div className="d-flex align-items-center g-10">
                                        <a href="#" className="position meta-item ff-2 fw-6">Marketing</a>
                                        <a href="#" className="date meta-item ff-2 fw-5">20 Jan 2026</a>
                                    </div>

                                </div>
                                <a href="/blog-detail" className="h3 name-card fw-5 letter-space--3">
                    ...
                    <div className="col-lg-6">
                        <div className="blog-card style-2 hover-img wow fadeInUp">
                            <a href="/blog-detail" className="image image-blog">
                                <img loading="lazy" width="630" height="430"
                                    src="./assets/images/blog/img-blog-card-9.jpg" alt="Image" />
                            </a>
                            <div className="card-content">
                                <div className="meta d-flex align-items-center flex-wrap g-30 rg-15">
                                    <a href="#" className="user-blog d-flex align-items-center g-15">
                                ...
                                <a href="/blog-detail" className="h3 name-card fw-5 letter-space--3">
                                    Conversion Rate Optimization Tips – Turning website visitors into loyal
                                    customers.
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="col-lg-6">
                        <div className="blog-card style-2 hover-img wow fadeInUp" data-wow-delay=".2s">
                            <a href="/blog-detail" className="image image-blog">
                                <img loading="lazy" width="630" height="430"
                                    src="./assets/images/blog/img-blog-card-10.jpg" alt="Image" />
                            </a>
                            <div className="card-content">
                                <div className="meta d-flex align-items-center flex-wrap g-30 rg-15">
                                    <a href="#" className="user-blog d-flex align-items-center g-15">
                                ...
                                <a href="/blog-detail" className="h3 name-card fw-5 letter-space--3">
                                    How Social Media Ads Can Boost Your Brand – Effective campaigns and best
                                    practices.
                                </a>
                            </div>
                        </div>
