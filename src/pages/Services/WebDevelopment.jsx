      ...
      <main id="wrapper">
                ...
                <div className="page-title-content">
                    <div className="content content-2">
                        <h1 className="title mb-xl-50">
                            <span style={{ color: "var(--digital-marketing-light)" }}>Web</span>
                            <br />Development
                            <br />Solutions
                        </h1>
                    ...
                    <div className="image">
                        <img loading="lazy" width="915" height="470"
                            src={Services1Image} alt="Web Development Services" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="container">
                <div className="heading-section mb-70 text-center">
                    ...
                    <h2 className="title letter-space--3 fw-6 mb-30">
                        <span style={{color:"var(--digital-marketing-blue)"}}>We believe in </span> exceptional web
                        <br />{" "}experiences, <span style={{color:"var(--digital-marketing-light)" }}>not just websites</span>. Our approach
                        ...
                        <div className="marketing-card style-2">
                            ...
                            <div className="content">
                                <div className="h5 title fw-6 letter-space--3">
                                    Creating high-performance websites, custom applications, and seamless digital experiences.
                                </div>
                                <p className="desc ff-2 fw-5">
                                    We ensure every web project delivers exceptional performance, security, and user experience
                                </p>
                    ...
                    <div className="col-lg-4">
                        <div className="image">
                            <img loading="lazy" width="553" height="500"
                                src={Services2Image} alt="Web Development Strategy" />
                        </div>
                    </div>
                    <div className="col-lg-4">
                                    ...
                                    <div className="counter mb-25">
                                        <div className="number-counter flex fs-65 fw-6">
                                            <span className="number odometer color-primary h1 letter-space--3 fw-6"
                                                data-to="99" data-inviewport="yes"> 0 </span>
                                            <span className="fs-60 lh-100 fw-6">%</span>
                                        </div>
                                    </div>
                                    <p className="text-body-1 fw-6 lh-100 ff-2 fw-6 color-paragraph letter-space--2">
                                        Website performance & speed improvement</p>
                                </div>
                            </div>
                            <div className="line"></div>
                            <div className="content-card">
                                <p className="desc mb-50 ff-2 color-paragraph">
                                    We build custom websites and applications that combine stunning design with robust functionality, ensuring exceptional user experiences and business growth.
                                </p>
        ...
        <section className="section-services p-services">
            ...
            <div className="container">
                <div className="heading-section mb-70 text-center">
                    <div className="sub-title h6 mb-10 letter-space--2 fw-5">
                        Comprehensive Web Services. <span>Design, Develop, Deploy.</span>
                    </div>
                    <h2 className="title letter-space--3 fw-6 mb-30">
                        <span style={{color:"var(--digital-marketing-blue)"}}>We deliver</span> <span style={{color:"var(--digital-marketing-light)"}}>cutting-edge</span> web
            ...
            <div className="container">
                <div className="heading-section">
                    <h1 className="title fw-6 letter-space--3 color-dt-black mb-70">
                        <span style={{ color: "var(--digital-marketing-blue)" }}>Ready to build</span> something
                        <br />{" "}extraordinary online
                        <br />{" "}with <span style={{ color: "var(--digital-marketing-light)" }}>web development expertise</span>
                    </h1>
                </div>
                <div className="section-cta-inner d-flex align-items-end justify-content-between g-30">
                    <div className="left">
                        <div className="text h5 fw-5 color-paragraph lh-35 ff-2 letter-space--2">
                            Web development is the foundation of 
                            your digital presence, creating experiences 
                        ...
                        <div className="bottom d-flex g-10 rg-30 align-items-end justify-content-between">
                            <div className="image img-min">
                                <img loading="lazy" width="270" height="215"
                                    src={Services9Image} alt="Web Development" />
                                </div>
                            <div className="right-bottom">
                                <ul className="list-benefit d-flex flex-column g-8 mb-25">
                                    <li className="benefit-item d-flex align-items-center g-7 color-paragraph">
                                        <i className="icon-check fs-18"></i>
                                        <span className="letter-space--2 text-nowrap">Custom Web Solutions</span>
                                    </li>
                                    <li className="benefit-item d-flex align-items-center g-7 color-paragraph">
                                        <i className="icon-check fs-18"></i>
                                        <span className="letter-space--2 text-nowrap">Performance Optimized</span>
                                    </li>
                                    <li className="benefit-item d-flex align-items-center g-7 color-paragraph">
                                        <i className="icon-check fs-18"></i>
                                        <span className="letter-space--2 text-nowrap">Responsive Design</span>
                                    </li>
                                    <li className="benefit-item d-flex align-items-center g-7 color-paragraph">
                                        <i className="icon-check fs-18"></i>
                                        <span className="letter-space--2 text-nowrap">Ongoing Support & Maintenance</span>
                                    </li>
                                </ul>
                    ...
                    <div className="image">
                        <img loading="lazy" width="630" height="430"
                            src={Services8Image} alt="Web Development Success" />
                    </div>
                </div>
            </div>
        </section>
