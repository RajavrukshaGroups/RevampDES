  ...
  return (
    <>
      <main id="wrapper">
        ...
        <header className="header style-4 header-fixed">
                    ...
                    <div className="header-right d-flex align-items-center justify-content-between">
                                    ...
                                    <li className="menu-item has-sub_menu">
                                        ...
                                        <div className="sub-menu">
                                            <ul className="sub-menu_list">
                                                ...
                                                <li>
                                                    <a href="/home-branding-agency" className="sub-menu_link">Home
                                                        Branding Agency</a>
                                                </li>
                                                <li>
                                                    <a href="/home-seo-marketing" className="sub-menu_link active">Home
                                                        Seo
                                                        Marketing</a>
                                                </li>
                                            </ul>
                        ...
                        <div className="d-flex align-items-center g-20">
                            <div className="d-sm-block d-none">
                                <a href="/contact" className="tf-btn style-sm-color-purple">
                                    <span className="text-btn">Contact</span>
        ...
        <footer className="footer style-4">
            <div className="img-sharp">
                <img src="./assets/images/widget/sharp-footer-4.png" alt="Image" />
            </div>
            <div className="footer-top">
                <div className="container w-1750">
                    <div className=" footer-top-inner d-flex justify-content-between">
                        <div className="footer-top-left">
                            <div className="box-company mb-50">
                                <p className="h5 title fw-6 letter-space--3 mb-xl-50 color-white">Company</p>
                                <p className="text color-white ff-2">
                                    We help businesses improve their search visibility, attract qualified traffic,
                                    and
                                    convert visitors into customers using proven SEO strategies.
                                </p>
                            </div>
                            <div className="box-social">
                                <p className="h5 title fw-6 letter-space--3 mb-25 color-white">Social Media</p>
                                <ul className="d-flex g-10">
                                    <li><a href="#" className="item-social style-2"><i className="icon-fb"></i></a></li>
                                    <li><a href="#" className="item-social style-2"><i className="icon-x"></i></a></li>
                                    <li><a href="#" className="item-social style-2"><i className="icon-ig"></i></a></li>
                                    <li><a href="#" className="item-social style-2"><i className="icon-in"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div className="footer-top-right">
                            <div className="list-footer-content d-flex g-30 justify-content-between">
                                <div className="footer-content footer-col-block footer-content-1">
                                    ...
                                    <div className="tf-collapse-content">
                                        <ul className="content">
                                            <li className="support-item-footer"><a href="/service-details"
                                                    className="ff-2">Branding
                                                    Solutions</a>
                                            </li>
                                            <li className="support-item-footer"><a href="/service-details"
                                                    className="ff-2">SEO Camping</a>
                                            </li>
                                            <li className="support-item-footer"><a href="/service-details"
                                                    className="ff-2">Digital
                                                    marketing</a>
                                            </li>
                                            <li className="support-item-footer"><a href="/service-details"
                                                    className="ff-2">Design &
                                                    Development</a></li>
                                            <li className="support-item-footer mb-0"><a href="/service-details"
                                                    className="ff-2">Influencer
                                                    Marketing</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div className="footer-content footer-col-block footer-content-1">
                                    ...
                                    <div className="tf-collapse-content">
                                        <ul className="content">
                                            <li className="support-item-footer mb-25">
                                                <a href="#"
                                                    className="ff-2 text-body-1 fw-5 letter-space--2 lh-30 color-white">
                                                    1234 Innovation Drive, Suite 500,
                                                    <br />San Francisco, CA 94105, USA
                                                </a>
                                            </li>
                                            <li className="support-item-footer mb-25">
                                                <a href="#"
                                                    className="ff-2 text-body-1 fw-5 letter-space--2 lh-30 color-white">supporttech@gmail.com</a>
                                            </li>
                                            <li className="support-item-footer">
                                                <a href="#"
                                                    className="ff-2 text-body-1 fw-5 letter-space--2 lh-30 color-white">+1
                                                    (310) 555-7890</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div className="footer-content footer-col-block footer-content-1">
                                    ...
                                    <div className="tf-collapse-content">
                                        <ul className="content">
                                            <li className="support-item-footer"><a href="/about-us" className="ff-2">Company
                                                    history</a>
                                            </li>
                                            <li className="support-item-footer"><a href="/services-1" className="ff-2">Our
                                                    Services</a>
                                            </li>
                                            <li className="support-item-footer"><a href="/blog-gird" className="ff-2">News &
                                                    Blogs</a>
                                            </li>
                                            <li className="support-item-footer mb-0"><a href="/our-team"
                                                    className="ff-2">Meet Our teams</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <a href="#" className="text-big text-big-2 letter-space--5 fw-7 title-animation">
                                SEONEX
                            </a>
                        </div>
                    </div>
                ...
                <div className="container w-1750">
                    <div className="bottom-footer-inner d-flex align-items-center justify-content-between g-20">
                        <span className="text-center ff-2 color-white">Copyright@ 2026 <span
                                className="color-white fw-6">SEONEX.</span> All Rights Reserved.</span>
                        <ul className="d-flex align-items-center flex-wrap justify-content-center">
                            <li><a href="/faqs" className="ff-2">FAQs</a></li>
                            <li><a href="#" className="ff-2">Privacy Policy</a></li>
                            <li><a href="/pricing-plan" className="ff-2">Pricing</a></li>
                            <li><a href="/contact" className="ff-2">Contact</a></li>
                        </ul>
                    </div>
                </div>
            </div>
