    ...
    <>
      <main id="wrapper">
                            ...
                            <ul className="box-nav-menu">
                                ...
                                <li className="menu-item has-sub_menu">
                                    ...
                                    <div className="sub-menu">
                                        <ul className="sub-menu_list">
                                            <li>
                                                <a href="/about-us" className="sub-menu_link active">About Us</a>
                                            </li>
                                            <li>
                    ...
                    <div className="col-lg-4">
                        <div className="testimonial-card">
                            ...
                            <p className="h5 text letter-space--3 fw-6 mb-50 lh-32">
                                “A reliable team that truly understands digital growth. Transparent, data-driven, and
                                highly effective.”
                            </p>
                            ...
                            <div className="testimonial-user">
                                <a href="#" className="h5 name fw-6 letter-space--3">Benjamin Harris</a>
                ...
                <div className="list-funfact-item p-about mt-100">
                    <div className="funfact-item-2">
                        <div className="progress-circle-svg" data-progress="99">
                            <svg className="progress-ring" width="154" height="154" viewBox="0 0 154 154">
                                <circle className="progress-ring-track" r="75" cx="77" cy="77" />
                                <circle className="progress-ring-bar" r="75" cx="77" cy="77" />
                            </svg>
                            <div className="inner-bg"></div>
                            <div className="text-number">
                                <span className="progress-text h4 fw-6 letter-space--3 color-white">0</span>
                                <span className="h4 fw-6 letter-space--3 color-white">%</span>
                            </div>
                        </div>
                        <div className="content-item">
                            ...
                            <p className="desc ff-2 color-paragraph">
                                ...
                                <br className="d-none d-xl-block" />expectations communication.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="funfact-item-2">
                        ...
                        <div className="content-item">
                            ...
                            <p className="desc ff-2 color-paragraph">
                                ...
                                <br className="d-none d-xl-block" />increase in Return on (ROAS).
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="funfact-item-2">
                        ...
                        <div className="content-item">
                            ...
                            <p className="desc ff-2 color-paragraph">
                                ...
                                <br className="d-none d-xl-block" />visibility strategically keywords
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="funfact-item-2">
                        ...
                        <div className="content-item">
                            ...
                            <p className="desc ff-2 color-paragraph">
                                ...
                                <br className="d-none d-xl-block" />designed to support brands.
                            </p>
                        </div>
                    </div>
        ...
        <section className="section-cta p-about">
            <div className="image">
                <img loading="lazy" src="./assets/images/section/img-bg-cta-p-about.jpg" alt="Image" />
            </div>
            <div className="container">
                <div className="content">
        ...
        <section className="section-team p-about flat-spacing-7">
            ...
            <div className="container">
                <div dir="ltr" className="swiper tf-swiper" data-laptop="4" data-preview="4" data-tablet="3"
                    data-mobile-sm="2" data-mobile="1" data-space-lg="70" data-space-md="30" data-space="30"
                    data-space-sm="15">
                    <div className="swiper-wrapper">
                            ...
                            <div className="team-card hover-img no-border">
                                <a href="/team-details" className="image">
                                    <img loading="lazy" width="270" height="270"
                                        src="./assets/images/team/img-team-1.jpg" alt="Image" />
                                </a>
                        ...
                        <div className="swiper-slide">
                            <div className="team-card hover-img no-border">
                                <a href="/team-details" className="image">
                                    <img loading="lazy" width="270" height="270"
                                        src="./assets/images/team/img-team-2.jpg" alt="Image" />
                                </a>
                                <div className="team-content">
                        ...
                        <div className="swiper-slide">
                            <div className="team-card hover-img no-border">
                                <a href="/team-details" className="image">
                                    <img loading="lazy" width="270" height="270"
                                        src="./assets/images/team/img-team-3.jpg" alt="Image" />
                                </a>
                                <div className="team-content">
                        ...
                        <div className="swiper-slide">
                            <div className="team-card hover-img no-border">
                                <a href="/team-details" className="image">
                                    <img loading="lazy" width="270" height="270"
                                        src="./assets/images/team/img-team-4.jpg" alt="Image" />
                                </a>
                                <div className="team-content">
        ...
        <section className="section-working-proccess flat-spacing-3 h-dm p-about">
            ...
            <div className="section-working-proccess-inner">
                <div dir="ltr" className="swiper tf-swiper mb-104" data-laptop="4.45" data-preview="4" data-tablet="3"
                    data-mobile-sm="2" data-mobile="1" data-space-lg="30" data-space-md="15" data-space="15"
                    data-center="true" data-init="2">
                    <div className="swiper-wrapper">
                ...
                <div className="container">
                    <div className="bottom">
                        <p className="text-2 h3 fw-6 letter-space--3 color-white mb-68">
                            You always know what’s working. Our clear reports, honest communication, and
                            <br />performance tracking keep you informed and confident at every step.
                        </p>
                        ...
                        <div className="list-why-item d-flex justify-content-between">
                            ...
                            <div className="why-item-2">
                                ...
                                <p className="desc ff-2">
                                    ...
                                    <br />is powered by real data, audience insights, and
                                    <br />performance metrics to ensure measurable.
                                </p>
                            </div>
                            <div className="why-item-2">
                                <p className="number ff-2 fw-6 letter-space--3 text-body-2 lh-100">
                                ...
                                <p className="desc ff-2">
                                    ...
                                    <br />marketing, we provide complete to solutions
                                    <br />under one roof—saving you complexity.
                                </p>
                            </div>
                            <div className="why-item-2">
                                <p className="number ff-2 fw-6 letter-space--3 text-body-2 lh-100">
                                ...
                                <p className="desc ff-2">
                                    ...
                                    <br />to your business goals, industry, and to target
                                    <br />audience for sustainable success.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <section className="section-testimonials flat-spacing-1">
            <div className="container">
                ...
                <div dir="ltr" className="swiper tf-swiper" data-laptop="3" data-preview="3" data-tablet="2"
                    data-mobile-sm="2" data-mobile="1" data-group-sm="2" data-space-lg="30" data-space-md="20"
                    data-space="15">
                    <div className="swiper-wrapper">
