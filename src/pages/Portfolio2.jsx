                                ...
                                <li className="menu-item has-sub_menu">
                                    ...
                                    <div className="sub-menu">
                                        <ul className="sub-menu_list">
                                            ...
                                            <li>
                                                <a href="/portfolio-2" className="sub-menu_link active">Portfolio 2</a>
                                            </li>
                                            <li>
                                                <a href="/portfolio-details" className="sub-menu_link">Portfolio Details</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                ...
                <div className="container w-1650">
                    <div className="top-footer">
                        <p className="big-text split-text effect-right">Let’s Connect
                            <br /><span className="img d-none d-sm-inline-block wow fadeInRight"><img loading="lazy" width="350" height="130"
                                    src="./assets/images/section/img-footer-title.jpg" alt="Image" /></span> together
