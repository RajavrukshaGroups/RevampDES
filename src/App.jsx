  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/services/Digital-marketing-agency-in-bangalore"
          element={<Services1 />}
        />
        ...
        <Route
          path="/services/social-media-marketing-company-bangalore"
          element={<SocialMediaMarketing />}
        />
        <Route
          path="/services/web-development-company-bangalore"
          element={<WebDevelopment />}
        />
        <Route
          path="/services/graphic-design-company-bangalore"
          element={<GraphicDesign />}
        />
        <Route
          path="/services/lead-generation-companies-in-bangalore"
          element={<LeadGeneration />}
        />
        <Route
          path="/services/whatsapp-automation-AI-providers-india"
          element={<WhatsappAutomation />}
        />

        <Route
          path="/graphic-design-service-details"
          element={<GraphicDesignServiceDetails />}
        />
        <Route
          path="/digital-marketing-service-details"
          element={<DigitalMarketingServiceDetails />}
        />
        <Route path="/seo-service-details" element={<SEOServiceDetails />} />
        <Route
          path="/social-media-marketing-service-details"
          element={<SocialMediaMarketingServiceDetails />}
        />
        <Route
          path="/web-development-service-details"
          element={<WebDevelopmentServiceDetails />}
        />
        <Route
          path="/lead-generation-service-details"
          element={<LeadGenerationServiceDetails />}
        />
        <Route
